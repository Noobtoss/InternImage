...
# Script taken from: https://github.com/Asthestarsfalll/CrowdHuman/tree/main
# Adapted following Issue: https://github.com/Asthestarsfalll/CrowdHuman/issues/1
# Usage: python crowdhuman2coco.py -d ../../../datasets/CrowdHuman/Images/ -o ../../../datasets/CrowdHuman/annotation_train.odgt -s ../../../datasets/CrowdHuman/annotation_train.json
# Usage: python crowdhuman2coco.py -d ../../../datasets/CrowdHuman/Images/ -o ../../../datasets/CrowdHuman/annotation_val.odgt -s ../../../datasets/CrowdHuman/annotation_val.json
def make_parser():
...
def crowdhuman2coco(args, odgt_path, json_path, data_path):
    ...
    for image_id, image_dict in enumerate(records):
        ...
        for _, instance in enumerate(gt_box):
            ...
            if args.full:
                attr = instance['extra']
                if args.rm_occ and attr.get('ignore'):
                    continue
